    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Toast.makeText(GoogleSignInActivity.this, "firebaseAuthWithGoogle"+account.getId(), Toast.LENGTH_SHORT).show();

                System.out.println("token Id:"+account.getIdToken());
                firebaseAuthWithGoogle(account.getIdToken());
            } catch (ApiException e) {
                // Google Sign In failed, update UI appropriately
                Toast.makeText(GoogleSignInActivity.this, "Google sign in failed"+e, Toast.LENGTH_SHORT).show();
                progressDialog.dismiss();
                finish();
